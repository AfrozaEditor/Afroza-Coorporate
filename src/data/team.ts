...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio:
      "Melotech intervient sur la mise en production, l'automatisation et la stabilité des plateformes. Il aide l'équipe à livrer plus vite sans perdre le contrôle opérationnel.",
    location: "Yaoundé, Cameroun",
